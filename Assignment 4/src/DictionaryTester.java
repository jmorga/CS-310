...
public class DictionaryTester {
    ...
    public static void main(String [] args) {
        ...
        Iterator<String> sit2 = dictionary.keys();
        Iterator<Integer> it2 = dictionary.values();
        
        
        
        while(sit2.hasNext())
        {
        		System.out.println(sit2.next() +" "+ it2.next());
        }
        System.out.println("Size: " + dictionary.size());
        //dictionary.clear();
        dictionary.delete("AAA000");
        dictionary.delete("DAA000");
//        dictionary.delete("BAA000");
//        System.out.println("\n");
//        System.out.println("Adding JZZ000: " + dictionary.add("JZZ000", 10));
//        System.out.println("Adding JZZ001: " + dictionary.add("JZZ001", 10));
//        
//        
...
//        
//        
        sit2 = dictionary.keys();
        it2 = dictionary.values();
        ...
        System.out.println("Size: " + dictionary.size());
        System.err.println("dictionary contains \"BAA000\": "+dictionary.contains("BAA000"));
//        System.err.println("dictionary contains \"JZZ002\": "+dictionary.contains("JZZ002"));
//        System.out.println("Is full: "+ dictionary.isFull());
