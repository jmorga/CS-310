...
//        try{
//        		output = new PrintWriter(new FileOutputStream("measurements.txt"));
//        }
...
//            output.println(removeTimes[i] *.001);
//            tmp <<= 1;
//            }   
//        output.close();
//        }
